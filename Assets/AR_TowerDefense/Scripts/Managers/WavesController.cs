...
namespace Battlerock
{
    ...
    public class WavesController : MonoBehaviour
    {
        ...
        public IEnumerator MoveToNextSubWaveIfPossible()
        {
            ...
            GetCurrentSubWave.isSubWaveCompleted = true;
            Debug.Log("Current Sub-Wave " + GetCurrentSubWaveIndex + ": COMPLETE!");

            //PLAY GONG
            if (AudioController.Instance != null)
            {
                AudioController.Instance.PlayAudio2D(SOUNDS.GONG);
            }
            else
            {
                Debug.LogError("Missing Audio controller");
            }
            ...
            if (IsCurrentWaveCompleted == true)
            {
                ...
                {
                    // Trigger the camera to move.
                    EventManager.TriggerEvent("WaveComplete");
                }
            }
        ...
        public IEnumerator AllWavesClear()
        {
            ...
            EventManager.TriggerEvent("SpawnLevelCompleteObject");
