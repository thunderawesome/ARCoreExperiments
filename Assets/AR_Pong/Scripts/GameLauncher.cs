    ...
    public class GameLauncher : Photon.PunBehaviour
    {
        ...
        public void Connect()
        {
            ...
            else
            {
                ...
                PhotonNetwork.ConnectUsingSettings(NetworkSettings.Instance.gameVersion);
            }
        }
        ...
        public override void OnConnectedToMaster()
        {
            ...
            if (isConnecting)
            {
                ...
                Debug.Log(GetType() + ": OnConnectedToMaster() was called by PUN. Now this client is connected and could join a room.\n Calling: PhotonNetwork.JoinRandomRoom(); Operation will fail if no room found");
        ...
        public override void OnPhotonRandomJoinFailed(object[] codeAndMsg)
        {
            ...
            Debug.Log(GetType() + ":OnPhotonRandomJoinFailed() was called by PUN. No random room available, so we create one.\nCalling: PhotonNetwork.CreateRoom(null, new RoomOptions() {maxPlayers = 4}, null);");

            // #Critical: we failed to join a random room, maybe none exists or they are all full. No worries, we create a new room.
            PhotonNetwork.CreateRoom(null, new RoomOptions() { MaxPlayers = NetworkSettings.Instance.maxPlayersPerRoom }, null);
        }
